...
public class InnerProject_AddMember_Adapter extends RecyclerView.Adapter<InnerProject_AddMember_Adapter.CustomViewHolder> {
    ...
    public InnerProject_AddMember_Adapter(ArrayList<InnerProject_AddMemberDTO> arrayList, String memberListEmail,
                                          String memberListHP, String memberListName, Context context) {
    ...
    public void onBindViewHolder(@NonNull CustomViewHolder holder, int position) {
        ...
        holder.itemView.setOnClickListener(new View.OnClickListener() { //리사이클러뷰 아이템 클릭 이벤트
            @Override
            public void onClick(View view) {
                ...
                ((InnerProject)InnerProject.mContext).memberListLoad(); //InnerProject의 멤버 리사이클러뷰를 다시 불러옴.
            }
        });
    }
